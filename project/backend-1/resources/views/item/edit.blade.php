...
<div 
        ...
        <select
            ...
            <option value="{{ $object->id }}"{{ $object->id === $data->units_id ? 'selected' : '' }}>{{ $object->nama_satuan }}</option>
            @endforeach
        </select>
</div>
